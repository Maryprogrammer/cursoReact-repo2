...
const Form1 = () => {
    const [formData, setFormData] = useState({//el nombre es formdata
    numero: '',
    fecha: '',
    remitente: '',
    resumen: '',
...
const handleChange = (e) => { //para que se generen cambios en los campos
...
const handleSubmit = async (e) => {
    e.preventDefault();//para que no se vuelva a recargar el formulario
    try {
      // Validación básica
